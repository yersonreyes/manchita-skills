...
export class EscenarioDto {
  ...
  @ApiPropertyOptional()
  @IsOptional()
  @IsIn(['happy-path', 'edge-case', 'error', 'contextual', 'day-in-life', ''])
  tipo?: string;
...
export class DisenioEscenariosAnalyzeReqDto {
  ...
  @ApiProperty({ type: DisenioEscenariosDataDto })
  @ValidateNested()
  @Type(() => DisenioEscenariosDataDto)
  data: DisenioEscenariosDataDto;
