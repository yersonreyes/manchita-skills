...
export class DisenioEscenariosController {
  constructor(private readonly analyzeService: DisenioEscenariosAnalyzeService) {}
  ...
  analyze(@Body() dto: DisenioEscenariosAnalyzeReqDto): Promise<DisenioEscenariosAnalyzeResDto> {
