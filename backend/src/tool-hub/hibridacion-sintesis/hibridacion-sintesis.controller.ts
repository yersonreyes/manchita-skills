...
export class HibridacionSintesisController {
  constructor(private readonly analyzeService: HibridacionSintesisAnalyzeService) {}

  @Post('analyze')
  @RequirePermission('tool-applications:update')
  @ApiOperation({ summary: 'Genera un análisis AI de la Hibridación por Síntesis' })
  @ApiResponse({ status: 201, type: HibridacionSintesisAnalyzeResDto })
  analyze(@Body() dto: HibridacionSintesisAnalyzeReqDto): Promise<HibridacionSintesisAnalyzeResDto> {
