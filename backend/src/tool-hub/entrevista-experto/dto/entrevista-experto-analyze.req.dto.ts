...
export class EntrevistaExpertoDataDto {
  ...
  @ApiProperty({ type: [EntrevistaExpertoRespuestaDto] }) @IsArray() @ValidateNested({ each: true }) @Type(() => EntrevistaExpertoRespuestaDto) respuestas: EntrevistaExpertoRespuestaDto[];
  @ApiProperty({ type: [String] }) @IsArray() @IsString({ each: true }) citasTecnicas: string[];
...
export class EntrevistaExpertoAnalyzeReqDto {
  ...
  @ApiProperty({ type: EntrevistaExpertoDataDto }) @ValidateNested() @Type(() => EntrevistaExpertoDataDto) data: EntrevistaExpertoDataDto;
