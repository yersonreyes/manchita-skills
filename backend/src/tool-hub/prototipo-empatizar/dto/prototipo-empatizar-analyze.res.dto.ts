...
export class FriccionEmocionalDto {
  ...
  @ApiProperty({ enum: ['alta', 'media', 'baja'] }) intensidad:
    | 'alta'
    | 'media'
    | 'baja';
}
...
export class SupuestoContrastadoDto {
  ...
  @ApiProperty({ enum: ['validado', 'refutado', 'parcial'] }) resultado:
    | 'validado'
    | 'refutado'
    | 'parcial';
...
export class PrototipoEmpatizarReportDto {
  ...
  @ApiProperty({ type: [FriccionEmocionalDto] })
  friccionesEmocionales: FriccionEmocionalDto[];
  @ApiProperty({ type: [SupuestoContrastadoDto] })
...
export class PrototipoEmpatizarAnalyzeResDto {
  ...
  @ApiProperty({ type: PrototipoEmpatizarReportDto })
