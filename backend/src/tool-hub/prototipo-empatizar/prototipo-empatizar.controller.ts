...
export class PrototipoEmpatizarController {
  constructor(
    private readonly analyzeService: PrototipoEmpatizarAnalyzeService,
  ) {}

  @Post('analyze')
  @RequirePermission('tool-applications:update')
  @ApiOperation({
    summary: 'Genera un análisis AI del Prototipo para Empatizar',
  })
  @ApiResponse({ status: 201, type: PrototipoEmpatizarAnalyzeResDto })
  analyze(
    @Body() dto: PrototipoEmpatizarAnalyzeReqDto,
