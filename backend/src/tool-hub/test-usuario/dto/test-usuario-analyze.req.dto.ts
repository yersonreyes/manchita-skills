...
export class SesionTestDataDto {
  ...
  @ApiProperty({ type: [TareaObservadaDataDto] })
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => TareaObservadaDataDto)
  tareas: TareaObservadaDataDto[];
...
export class TestUsuarioDataDto {
  ...
  @ApiProperty({ type: [SesionTestDataDto] })
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => SesionTestDataDto)
  sesiones: SesionTestDataDto[];
...
export class TestUsuarioAnalyzeReqDto {
  ...
  @ApiProperty({ type: TestUsuarioDataDto })
  @ValidateNested()
  @Type(() => TestUsuarioDataDto)
  data: TestUsuarioDataDto;
