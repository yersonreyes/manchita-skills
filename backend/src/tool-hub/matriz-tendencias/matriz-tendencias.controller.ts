...
export class MatrizTendenciasController {
  constructor(private readonly analyzeService: MatrizTendenciasAnalyzeService) {}
  ...
  analyze(@Body() dto: MatrizTendenciasAnalyzeReqDto): Promise<MatrizTendenciasAnalyzeResDto> {
