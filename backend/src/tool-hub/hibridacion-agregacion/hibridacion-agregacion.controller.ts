...
export class HibridacionAgregacionController {
  constructor(
    private readonly analyzeService: HibridacionAgregacionAnalyzeService,
  ) {}

  @Post('analyze')
  @RequirePermission('tool-applications:update')
  @ApiOperation({
    summary: 'Genera un análisis AI de la Hibridación por Agregación',
  })
  @ApiResponse({ status: 201, type: HibridacionAgregacionAnalyzeResDto })
  analyze(
    @Body() dto: HibridacionAgregacionAnalyzeReqDto,
