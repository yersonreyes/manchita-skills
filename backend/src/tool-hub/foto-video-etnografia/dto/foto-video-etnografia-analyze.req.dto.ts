...
export class FotoVideoEtnografiaDataDto {
  ...
  @ApiProperty({ type: [FotoVideoRegistroDto] }) @IsArray() @ValidateNested({ each: true }) @Type(() => FotoVideoRegistroDto) registros: FotoVideoRegistroDto[];
  @ApiPropertyOptional() @IsOptional() @IsString() patronesVisuales?: string;
  @ApiProperty({ type: [String] }) @IsArray() @IsString({ each: true }) citasVisuales: string[];
...
export class FotoVideoEtnografiaAnalyzeReqDto {
  ...
  @ApiProperty({ type: FotoVideoEtnografiaDataDto }) @ValidateNested() @Type(() => FotoVideoEtnografiaDataDto) data: FotoVideoEtnografiaDataDto;
