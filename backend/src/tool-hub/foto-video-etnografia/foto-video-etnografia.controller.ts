...
export class FotoVideoEtnografiaController {
  constructor(private readonly analyzeService: FotoVideoEtnografiaAnalyzeService) {}
  ...
  analyze(@Body() dto: FotoVideoEtnografiaAnalyzeReqDto): Promise<FotoVideoEtnografiaAnalyzeResDto> {
