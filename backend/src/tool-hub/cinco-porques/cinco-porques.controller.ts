...
import {
  CincoPorquesChatReqDto,
  CincoPorquesAnalyzeReqDto,
} from './dto/cinco-porques.req.dto';
import {
  CincoPorquesChatResDto,
  CincoPorquesAnalyzeResDto,
} from './dto/cinco-porques.res.dto';
...
export class CincoPorquesController {
  ...
  @ApiOperation({
    summary: 'Ejecuta un turno de conversación guiada con Los 5 Porqués',
  })
  ...
  @RequirePermission('tool-applications:update')
  @ApiOperation({
    summary: 'Genera el análisis final de una sesión de Los 5 Porqués',
  })
  @ApiResponse({ status: 201, type: CincoPorquesAnalyzeResDto })
  analyze(
    @Body() dto: CincoPorquesAnalyzeReqDto,
