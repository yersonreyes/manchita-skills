...
export class EntrevistaCualitativaDataDto {
  ...
  @ApiProperty({ type: [EntrevistaRespuestaDto] }) @IsArray() @ValidateNested({ each: true }) @Type(() => EntrevistaRespuestaDto) respuestas: EntrevistaRespuestaDto[];
...
export class EntrevistaCualitativaAnalyzeReqDto {
  ...
  @ApiProperty({ type: EntrevistaCualitativaDataDto }) @ValidateNested() @Type(() => EntrevistaCualitativaDataDto) data: EntrevistaCualitativaDataDto;
