...
export class PrototipoFuncionalController {
  constructor(private readonly analyzeService: PrototipoFuncionalAnalyzeService) {}
  ...
  analyze(@Body() dto: PrototipoFuncionalAnalyzeReqDto): Promise<PrototipoFuncionalAnalyzeResDto> {
