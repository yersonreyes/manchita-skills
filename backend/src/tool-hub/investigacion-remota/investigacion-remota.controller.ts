...
export class InvestigacionRemotaController {
  constructor(private readonly analyzeService: InvestigacionRemotaAnalyzeService) {}
  ...
  analyze(@Body() dto: InvestigacionRemotaAnalyzeReqDto): Promise<InvestigacionRemotaAnalyzeResDto> {
