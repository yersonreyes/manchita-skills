...
export class VisitaDto {
  ...
  @ApiProperty({ type: [HallazgoVisitaDto] })
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => HallazgoVisitaDto)
...
export class VisitaCampoAnalyzeReqDto {
  ...
  @ApiProperty({ type: VisitaCampoDataDto })
  @ValidateNested()
  @Type(() => VisitaCampoDataDto)
  data: VisitaCampoDataDto;
