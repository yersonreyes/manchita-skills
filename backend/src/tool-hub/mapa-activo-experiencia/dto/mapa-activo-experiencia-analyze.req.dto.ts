...
export class MapaActivoExperienciaDataDto {
  ...
  @ApiProperty({ type: [EtapaActivaDto] })
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => EtapaActivaDto)
  etapas: EtapaActivaDto[];
}

export class MapaActivoExperienciaAnalyzeReqDto {
  @ApiProperty() @IsNumber() toolApplicationId: number;
  @ApiProperty({ type: MapaActivoExperienciaDataDto })
  @ValidateNested()
  @Type(() => MapaActivoExperienciaDataDto)
  data: MapaActivoExperienciaDataDto;
