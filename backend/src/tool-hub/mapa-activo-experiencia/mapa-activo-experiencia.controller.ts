...
export class MapaActivoExperienciaController {
  constructor(private readonly analyzeService: MapaActivoExperienciaAnalyzeService) {}

  @Post('analyze')
  @RequirePermission('tool-applications:update')
  @ApiOperation({ summary: 'Genera un análisis AI del Mapa Activo de la Experiencia' })
  @ApiResponse({ status: 201, type: MapaActivoExperienciaAnalyzeResDto })
  analyze(@Body() dto: MapaActivoExperienciaAnalyzeReqDto): Promise<MapaActivoExperienciaAnalyzeResDto> {
