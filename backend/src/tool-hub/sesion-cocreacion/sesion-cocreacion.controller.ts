...
export class SesionCocreacionController {
  constructor(private readonly analyzeService: SesionCocreacionAnalyzeService) {}
  ...
  analyze(@Body() dto: SesionCocreacionAnalyzeReqDto): Promise<SesionCocreacionAnalyzeResDto> {
