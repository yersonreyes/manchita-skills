...
import {
  RolePlayChatReqDto,
  RolePlayAnalyzeReqDto,
} from './dto/role-play.req.dto';
import {
  RolePlayChatResDto,
...
export class RolePlayController {
  ...
  @ApiOperation({
    summary: 'Ejecuta un turno de simulación de Role Play facilitado por IA',
  })
  ...
  @RequirePermission('tool-applications:update')
  @ApiOperation({
    summary: 'Genera el análisis final de una sesión de Role Play',
  })
