...
export class HibridacionTraslacionController {
  constructor(
    private readonly analyzeService: HibridacionTraslacionAnalyzeService,
  ) {}

  @Post('analyze')
  @RequirePermission('tool-applications:update')
  @ApiOperation({
    summary: 'Genera un análisis AI de la Hibridación por Traslación',
  })
  @ApiResponse({ status: 201, type: HibridacionTraslacionAnalyzeResDto })
  analyze(
    @Body() dto: HibridacionTraslacionAnalyzeReqDto,
