...
export class SesionShadowingDto {
  ...
  @ApiProperty({ type: [ObservacionShadowingDto] }) @IsArray() @ValidateNested({ each: true }) @Type(() => ObservacionShadowingDto) observaciones: ObservacionShadowingDto[];
...
export class ShadowingDataDto {
  ...
  @ApiProperty({ type: [SesionShadowingDto] }) @IsArray() @ValidateNested({ each: true }) @Type(() => SesionShadowingDto) sesiones: SesionShadowingDto[];
...
export class ShadowingAnalyzeReqDto {
  ...
  @ApiProperty({ type: ShadowingDataDto }) @ValidateNested() @Type(() => ShadowingDataDto) data: ShadowingDataDto;
