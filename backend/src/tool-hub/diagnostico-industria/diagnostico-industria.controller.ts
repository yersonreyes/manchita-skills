...
export class DiagnosticoIndustriaController {
  constructor(private readonly analyzeService: DiagnosticoIndustriaAnalyzeService) {}

  @Post('analyze')
  @RequirePermission('tool-applications:update')
  @ApiOperation({ summary: 'Genera un informe AI del diagnóstico de industria (5 Fuerzas de Porter)' })
  @ApiResponse({ status: 201, type: DiagnosticoIndustriaResDto })
  analyze(@Body() dto: DiagnosticoIndustriaReqDto): Promise<DiagnosticoIndustriaResDto> {
